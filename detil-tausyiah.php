      ...
      <div class="container mt-30 mb-30 pt-30 pb-30">
        <div class="row">
          <div class="col-md-9">
			...
			<?php
				if(isset($_GET['tausyiah'])){
					$judul_wakaf = str_replace("-"," ",$_GET['tausyiah']);
					$stmt = $mysqli->query("select * from tbl_post where status_post='done' AND tipe_post='tausyiah' AND judul_post='".$judul_wakaf."'");
					if($stmt->num_rows>0){
                  ...
                  <div class="col-sm-12">
					...
					<?php
						if(isset($_POST['btnPostKomentar'])){
							...
							if($stmt){
								echo'<meta http-equiv="Refresh" content="0; URL=?wakaf='.$_GET['tausyiah'].'">';
								echo '		
            ...
            <div class="sidebar sidebar-left mt-sm-30">
              ...
              <div class="widget">
                ...
                <div class="latest-posts">
                  <?php
						$stmt = $mysqli->query("select * from tbl_post where status_post='done' AND (tipe_post='berita' OR tipe_post='tausyiah') order by id_post DESC LIMIT 0,5");
						while($data = $stmt->fetch_object()){
							echo'
