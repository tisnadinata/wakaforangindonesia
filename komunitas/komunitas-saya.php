        ...
        <div class="container fullwidth">
            <div class="row">
                ...
                <div class="col-md-6">
                    <!-- Main Content -->
                    <div class="main-content">
                        <h1 class="font-weight-700 font-28">Komunitas Yang Anda Ikuti</h1>
						<br>
                        ...
                        <div class="filter">
                            ...
                            <div class="komunitas-list" id="daftar_komunitas">								
								<?php
								if(isset($_GET['leav'])){
									$stmt = $mysqli->query("delete from tbl_komunitas_anggota where id_komunitas=".$_GET['leav']." AND id_user=".$_COOKIE['login_id']."");
									if($stmt){
										echo '		
											<div class="divider divider--xs"></div>
											<div class="alert alert-success" role="alert" align="center">
												Anda telah keluar dari komunitas , terimakasih atas partisipasinya
											</div>
										';										
									}else{
										echo '		
											...
											<div class="alert alert-danger" role="alert" align="center">
												Maaf, anda gagal menghapus data keanggotaan dari komunitas .</b>
											</div>
										';										
									}
								}
								if(isset($_POST['btnJoinKomunitas'])){
									...
									$stmt = $mysqli->query("select * from tbl_komunitas,tbl_komunitas_anggota where tbl_komunitas_anggota.id_user=".$_COOKIE['login_id']." AND tbl_komunitas.id_komunitas=tbl_komunitas_anggota.id_komunitas ORDER BY tbl_komunitas.id_komunitas DESC LIMIT ".$posisi.",6");
									while($data_komunitas = $stmt->fetch_object()){
										...
										echo'
											<a class="btn btn-danger col-md-4 col-xs-12 pull-right text-uppercase" title="Login untuk bergabung" href="?leav='.$data_komunitas->id_komunitas.'">Keluar Komunitas</a>
										';										
										echo'	</div>
											</div>
											</form>
										...
										<ul class="pagination theme-colored">
											...
											<?php				
												if(!isset($_POST['btnCariKomunitas'])){
													...
													$stmt = $mysqli->query("select * from tbl_komunitas,tbl_komunitas_anggota where tbl_komunitas_anggota.id_user=".$_COOKIE['login_id']." AND tbl_komunitas.id_komunitas=tbl_komunitas_anggota.id_komunitas ORDER BY tbl_komunitas.id_komunitas DESC");
