    ...
    <header id="header" class="header">
							...
							echo'
								<div class="col-md-3 flip sm-text-center">
									<div class="widget m-0"><span class="cart-icons icon-sm">
										<a href="konfirmasi-wakaf.php"><i class="fa fa-shopping-cart">
        ...
        <div class="header-nav">
            <div class="header-nav-wrapper navbar-scrolltofixed  bg-theme-colored">
                <div class="container">
                    <nav id="menuzord-right" class="menuzord default no-bg"> <a class="menuzord-brand pull-left flip text-white" href="index.php"><img src="images/logo-woi-60.png" alt="" /><span class="addon-logo"> member of &nbsp; &nbsp;<img src="images/bwa-logo-60.png" alt="" /> &nbsp;&nbsp; family</span></a>
                        <ul class="menuzord-menu">
                                ...
                                <ul class="dropdown">
									<?php
										...
										while($data = $stmt->fetch_object()){
											...
											echo"
												<li><a href='wakaf.php?program=".$kategori."'>".$data->deskripsi_kategori."</a></li>
											";
										}
									?>
                                </ul>
                            </li>
                            <li><a class="text-white" href="project-wakaf.php">Proyek</a></li>
                            <li><a class="text-white" href="#">Tausyiah </a> 
								<ul class="dropdown">
									<li><a href='tausyiah.php?pemateri=Ustad Hari Mukti'>Ustad Hari Moekti</a></li>
									<li><a href='tausyiah.php?pemateri=Ustad Felix Siauw'>Ustad Feilx Siauw</a></li>
                                </ul>
							</li>
                            <li><a class="text-white" href="komunitas-wakaf.php">Komunitas </a> </li>
                            <li><a class="text-white" href="#home">Connect Us</a>
                                <ul class="dropdown">
                                    <li><a href="tentang-kami.php">Siapa Kami?</a></li>
                                    <li><a href="tim-kami.php">Tim Kami</a></li>
                                    <li><a href="faq.php">Frequently Asked Question</a></li>
                                    <li><a href="#">Blog</a>
                                        <ul class="dropdown">
                                            <li><a href="berita-wakaf.php">Berita Wakaf</a></li>
                                            <li><a href="inspirasi.php">Inspirasi</a></li>
                                            <li><a href="dan-lain-lain.php">Dan Lain-Lain</a></li>
                                        </ul>
                                    </li>
                                </ul>
                            </li>
							<?php
								if(isset($_COOKIE['login_id'])){
									...
									$nama = $nama[0];
									echo'
										<li><a class="text-white" href="area-wakif.php"><i class="fa fa-user" aria-hidden="true"></i> '.$nama.' </a>
											<ul class="dropdown">
												<li><a href="area-wakif.php">Area Member</a></li>
