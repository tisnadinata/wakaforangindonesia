            ...
            <div class="col-sm-6 col-md-3">
                <div class="widget dark">
                    ...
                    <ul class="list angle-double-right list-border">
                        <li><a href="komunitas-wakaf.php">Gabung Komunitas</a></li>
                        <li><a href="project-wakaf.php">Project Wakaf</a></li>
                        <li><a href="tausyiah.php">Tausyiah</a></li>
                    </ul>
                </div>
            </div>
            <div class="col-sm-6 col-md-3">
                <div class="widget dark">
                    ...
                    <ul class="list angle-double-right list-border">
                        <li><a href="term-conditions.php">Syarat dan Ketentuan</a></li>
