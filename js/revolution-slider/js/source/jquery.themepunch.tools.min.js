...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push( function() {
	...
	_gsScope._gsDefine("plugins.CSSPlugin", ["plugins.TweenPlugin","TweenLite"], function(TweenPlugin, TweenLite) {
		...
		var _getFormatter = function(dflt, clr, collapsible, multi) {
			 ...
			 * @return {CSSPropTween} The first CSSPropTween in the linked list which templ the new one(s) added by the parseComplex() call.
			 */
		 ...
		 * @return {CSSPropTween} The first CSSPropTween in the linked list which templ the new one(s) added by the parse() call.
		 */
