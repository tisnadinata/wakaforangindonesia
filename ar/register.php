    ...
    <section class="inner-header divider parallax layer-overlay overlay-dark-5" style="height:auto !important;" data-stellar-background-ratio="0.5" data-bg-img="../images/campaign/kids.jpg">
        <div class="container pt-100 pb-50">
            ...
            <div class="section-content pt-100">
                <div class="row">
                    <div class="col-md-12">
                        <h3 class="title text-white">Buat Akun Representative/Executive</h3>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-md-6 col-md-push-3">
                        <div class="icon-box mb-0 p-0">
                            ...
                            <h4 class="text-gray pt-10 mt-0 mb-30">Buat akun representative/executive mu sekarang.</h4>
                        </div>
                        <hr>
						<?php
                    ...
                    <form name="reg-form" class="register-form" method="post"  enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <input id="form_name" name="telepon" class="form-control" onKeyUp="validAngka(this)"  placeholder="08123456789" value="<?php echo $_SESSION['telepon'];?>" type="text" readonly>
                            </div>
                            <div class="form-group col-md-6">
                                <label>Email</label>
