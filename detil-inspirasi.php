    ...
    <section class="inner-header divider parallax layer-overlay overlay-dark-5" data-stellar-background-ratio="0.5" data-bg-img="images/campaign/kids.jpg">
      <div class="container pt-100 pb-50">
        ...
        <div class="section-content pt-100">
          <div class="row"> 
            <div class="col-md-12">
              <h3 class="title text-white">Inspirasi</h3>
            </div>
          </div>
        </div>
      </div>
            ...
            <div class="blog-posts single-post">
                  ...
                  <div class="entry-meta media no-bg no-border mt-15 pb-20">
                    ...
                    <div class="media-body pl-15">
                      <div class="event-content pull-left flip">
                        <h4 class="entry-title text-white text-uppercase m-0"><a href="#">Judul Blog Inspirasi</a></h4>
                        <span class="mb-10 text-gray-darkgray mr-10 font-13"><i class="fa fa-commenting-o mr-5 text-theme-colored"></i> 214 Komentar</span>
                        <span class="mb-10 text-gray-darkgray mr-10 font-13"><i class="fa fa-heart-o mr-5 text-theme-colored"></i> 895 Suka</span>
                      </div>
                    </div>
                  </div>
              ...
              <div class="tagline p-0 pt-20 mt-5">
                <div class="row">
                  <div class="col-md-8">
                    <div class="tags">
                      <p class="mb-0"><i class="fa fa-tags text-theme-colored"></i> <span>Tag:</span> Al-qur'an, Wakaf, Listrik, Dakwah</p>
                    </div>
                  </div>
                  <div class="col-md-4">
              ...
              <div class="author-details media-post">
                ...
                <div class="post-right">
                  <h5 class="post-title mt-0 mb-0"><a href="#" class="font-18">Ahmad Basorah</a></h5>
                  ...
                  <li>
                    <div class="media comment-author"> <a class="media-left pull-left flip" href="#"><img class="img-thumbnail" src="http://placehold.it/75x75" alt=""></a>
                      <div class="media-body">
                        <h5 class="media-heading comment-heading">Ahmad Basorah berkata:</h5>
                        <div class="comment-date">23/09/2016</div>
                      ...
                      <form role="form" id="comment-form">
                        <div class="col-sm-6 pt-0 pb-0">
                          <div class="form-group">
                            <input type="text" class="form-control" required name="contact_name" id="contact_name" placeholder="Masukan Nama">
                          </div>
                          <div class="form-group">
                            <input type="text" required class="form-control" name="contact_email2" id="contact_email2" placeholder="Masukan Email">
                          </div>
                          <div class="form-group">
                            <input type="text" placeholder="Masukan Website" required class="form-control" name="subject">
                          </div>
                        </div>
                        <div class="col-sm-6">
                          <div class="form-group">
                            <textarea class="form-control" required name="contact_message2" id="contact_message2"  placeholder="Tinggalkan Pesan" rows="7"></textarea>
                          </div>
                          <div class="form-group">
              ...
              <div class="widget">
                ...
                <div class="categories">
                  <ul class="list list-border angle-double-right">
                    <li><a href="#">Keluarga Sakinah<span>(19)</span></a></li>
                    <li><a href="#">Anak Soleh dan Solehah<span>(21)</span></a></li>
                    <li><a href="#">Suami Istri<span>(15)</span></a></li>
                    <li><a href="#">Ekonomi Syariah<span>(35)</span></a></li>
                    <li><a href="#">Kisah Nabawiyah<span>(16)</span></a></li>
                  </ul>
                </div>
              </div>
              <div class="widget">
                <h5 class="widget-title line-bottom">Inspirasi Terkini</h5>
                <div class="latest-posts">
                  <article class="post media-post clearfix pb-0 mb-10">
                    <a class="post-thumb" href="#"><img src="https://placehold.it/75x75" alt=""></a>
                    <div class="post-right">
                      <h5 class="post-title mt-0"><a href="#">Judul Blog Inspirasi</a></h5>
